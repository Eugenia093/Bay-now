            ...
            <form @submit.prevent="registerUser">
                ...
                <div class="form-line">
                    ...
                    <div class="form-item">
                        ...
                        <span
                            ...
                            >Puterea parolei este {{ errorMessage }}</span
                        >
                    </div>
                </div>
                <div class="form-line">
                ...
                <div class="checkbox">
                    ...
                    <label class="check-text" for="checkbox1">
                        Eu accept
                        <router-link to="/">Termenii si Conditiile</router-link> si
                        notificarile privind confidențialitatea
                         și cookie-urile.
                    </label>
                </div>
                <div class="checkbox">
                    ...
                    <label for="checkbox2" class="check-text">
                        Doresc să primesc mesaje informative Buy-now cu cele mai bune oferte
                        si oferte speciale
                ...
                <div class="action-buttons">
                    ...
                    <action-button>
                        ...
                        <span v-else>CREATI UN CONT</span>
                    </action-button>
                   
                </div>
                <div class="form-footer">
                    <p>Aveti deja un cont?</p>
                    <router-link to="/login">LOGHEAZA-TE</router-link>
                </div>
            </form>
        </div>
    </section>
