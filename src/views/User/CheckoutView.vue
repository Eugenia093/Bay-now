<template>
    ...
    <sub-header
        heading="Verificare"
        subHeading="Completați comanda completând formularul de mai jos"
    />
    <section>
        <div class="container">
            <div class="coupon">
                <input type="text" placeholder="Scrie cudul cuponului tau" />
                <action-button>Aplica</action-button>
            </div>
            <form class="billing-info" @submit.prevent="placeOrder">
                <div class="form">
                    ...
                    <div class="form-control">
                        ...
                        <input
                            type="text"
                            placeholder="Numărul casei și numărul străzii"
                            required
                            v-model="userAddress"
                        />
                    </div>
                    ...
                    <div class="form-control">
                        <label>Note de comandă (opțional) </label>
                        <textarea
                            rows="10"
                            placeholder="Note despre comanda dvs., de ex. note speciale pentru livrare"
                        ></textarea>
                    </div>
                </div>
                <aside>
