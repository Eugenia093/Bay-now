    ...
    <section class="container">
        ...
        <div class="cart-item" v-if="loaded">
            ...
            <div class="product-details">
                <span>Acasa / {{ product.brand }}</span>
                <h4>{{ product.name }}</h4>
                <h4>{{ formattedPrice }}</h4>
                <select v-model="size">
                    <option disabled>Selecteaza marimea</option>
                    <option>M</option>
                    <option>XL</option>
                    <option>XXL</option>
                    <option>S</option>
                </select>
                <p class="weak" v-if="validSize">Selecteaza marimea</p>
        ...
        <product-preloader v-else> Se incarca produsul... </product-preloader>
    </section>
</template>
