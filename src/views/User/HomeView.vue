    ...
    <section class="hero__section">
        <div class="container">
            <div class="hero__text">
                ...
                <h1>Super oferta</h1>
                <h2>La toate produsele</h2>
                <p>Economisiți mai mult cu cupoane și obțineți până la 70% reducere!</p>
                <router-link to="/shop">
                    <action-button btnvalue="Start Cumparaturilor" />
                </router-link>
            </div>
        </div>
    </section>
...
.hero__section {
    ...
    background-image: url("https://raw.githubusercontent.com/Oluwafemi21/BuyIt/master/src/assets/images/hero4.webp");
