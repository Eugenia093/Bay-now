        ...
        <div class="container">
            <nav class="top__navigation">
                ...
                <div class="nav__links" :class="{ activeNav: showSideNav }">
                    ...
                    <router-link @click="hideNav" to="/">Acasa</router-link>
                    <router-link @click="hideNav" to="/shop">Magazin</router-link>
                    <router-link @click="hideNav" to="/blog">Blog</router-link>
                    <router-link @click="hideNav" to="/about">Despre noi</router-link>
                    ...
                    <template v-if="!user">
                        ...
                        <router-link
                            ...
                            class="auth-link"
                        >
                            <action-button>Conectati-va</action-button>
                        </router-link>
                    </template>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span>Mergi la cumparaturi</span>
                                </router-link>
                                <button
                                    @click="logout"
                                    class="dropdown-link"
